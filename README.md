...
- 🛠 **Реально делает работу** — читает/ищет/пишет/правит файлы, запускает команды, ищет и читает страницы в интернете, создаёт `.docx`.
...
| `/skills` · `/mcp` · `/lsp` | Скиллы, MCP-серверы, LSP |
...
**Расширения.** Скиллы (специализированные инструкции по запросу), серверы **MCP** (внешние инструменты), **LSP** (поиск ссылок и диагностика по коду), генерация **`.docx`** (включая формулы и таблицы), веб-поиск и чтение страниц.
